...
const ColorsList = (props) => {
  ...
  const columns = useMemo(
    () => [
      ...
      //     return (
      //       <>
      //         <input type="text" className="color_name" />
      //       </>
      //     );
      //   },
      // },
      ...
      // },
      {
        ...
        Cell: (cellProps) => {
          return (
            <>
              <input type="text" className="form-control color_name" />
            </>
          );
        },
      },

      {
        ...
        Cell: (cellProps) => {
          return (
            <>
              <input type="color" className="color_select" />
            </>
          );
        },
      },
  ...
  return (
    <div className="page-content">
      <MetaTags>
        <title>Colors | Velzon - React Admin & Dashboard Template</title>
      </MetaTags>
      <Container fluid>
        <BreadCrumb title="Colors List" pageTitle="Colors" />
