  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Category | Add Sub Category</title>
        </MetaTags>
        <Container fluid>
          <BreadCrumb title="Add Sub Category" pageTitle="Category" />
          <Row>
            <Col lg={8}>
              <Card>
                <CardBody>
                  <div className="mb-3">
                    <Label className="form-label" htmlFor="Enter Name">
                      Name
                    </Label>
                    <Input
                      type="text"
                  ...
                  <div className="mb-3">
                    ...
                    >
                      <option selected>Select feature Category</option>
