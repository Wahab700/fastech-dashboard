...
const EcommerceProducts = (props) => {
  ...
  console.clear();
  console.log("I got categorie", CategoriesReducerGet);
  ...
  const columns = useMemo(
    () => [
            ...
            <div className="d-flex align-items-center">
              <div className="flex-shrink-0 me-3">
                <div className="avatar-sm bg-light rounded p-1">
                  <img
                    src={`http://localhost:3000/${category.row.original.mobile_img}`}
                    alt=""
      ...
      //       <div className="d-flex align-items-center">
      //         <div className="flex-grow-1">
      //           <h5 className="fs-14 mb-1">{category.row.original.note}</h5>
      //         </div>
      //       </div>
      //     </>;
      //   },
  ...
  return (
    <div className="page-content">
      ...
      <Container fluid>
        <BreadCrumb title="Category List" pageTitle="Category" />
