...
// developers
import DevelopersPosition from "../pages/Developers/Add-Position/index";
import PositionsList from "../pages/Developers/Position-List/index";
import EditPosition from "../pages/Developers/Edit-Position/index";

// blogs
import AddBlog from "../pages/Blogs/Add-Blogs/index";
import BlogList from "../pages/Blogs/Blogs-List/index";
import EditBlog from "../pages/Blogs/Edit-Blogs/index";

// contact form data
import Contact from "../pages/Contact-form/index";

// subscription mail
import Subscriptions from "../pages/Subscriptions/index";

// Categories
import AddCategories from "../pages/Category/Add-Category/index";
import CategoryList from "../pages/Category/Category-List/index";
import AddSubCategory from "../pages/Category/Add-Sub-Category/index";
import ListSubCategory from "../pages/Category/List-Sub-Category/index";

// products
import AddProduct from "../pages/Products/Add-Product/index";
import ProductList from "../pages/Products/Product-List/index";

// brands
import AddBrands from "../pages/Brands/AddBrands/index";
import BrandsList from "../pages/Brands/BrandsList/index";

// colors
import AddColors from "../pages/Colors/AddColors/index";
import ColorsList from "../pages/Colors/ColorsList/index";

// sizes
import AddSizes from "../pages/Sizes/AddSizes/index";
import SizesList from "../pages/Sizes/SizesList/index";

// attributes
import AddAttributes from "../pages/Attributes/AddAttributes/index";
import AttributesList from "../pages/Attributes/AttributesList/index";

// customers
import CustomersList from "../pages/Customers/CustomersList/index";

// orders
import OrdersList from "../pages/Orders/OdersList/index";

// coupens
import Overview from "../pages/Coupens/Overview/index";
import AddCoupens from "../pages/Coupens/AddCoupon/index";
import CoupensList from "../pages/Coupens/CouponsList/index";

// analytics
import Coupens from "../pages/Analytics/Coupons/index";
import Orders from "../pages/Analytics/Orders/index";
import AnalyticsOverview from "../pages/Analytics/AnalyticsOverview/index";
import Prooducts from "../pages/Analytics/Products/index";
import Revenue from "../pages/Analytics/Revenue/index";
import AnalyticsSettings from "../pages/Analytics/AnalyticsSettings/index";
import Stocks from "../pages/Analytics/Stock/index";
import Taxes from "../pages/Analytics/Taxes/index";
import Variations from "../pages/Analytics/Variations/index";

// marketing overview
import MarketingOverview from "../pages/Marketing/MarketingOverview/index";

// comments
import Comments from "../pages/Comments/index";

// media
import MediaList from "../pages/Media/MediaList/index";

// reviews
import ReviewsList from "../pages/Reviews/ReviewsList/index";
...
const authProtectedRoutes = [
  ...
  // developers
  { path: "/developer-add-positions", component: DevelopersPosition },
  { path: "/developer-positions-list", component: PositionsList },
  { path: "/developer-edit-positions/:id", component: EditPosition },

  // Blogs
  { path: "/blogs-add-blog", component: AddBlog },
  { path: "/blogs-blog-list", component: BlogList },
  { path: "/blogs-edit-blog", component: EditBlog },

  // contact form data
  { path: "/contact-form-data", component: Contact },

  // subscription mails
  { path: "/subscription-mail", component: Subscriptions },

  // category
  { path: "/category-add-categories", component: AddCategories },
  { path: "/category-category-list", component: CategoryList },
  { path: "/category-add-sub-category", component: AddSubCategory },
  { path: "/category-list-sub-category", component: ListSubCategory },
  ...
  // brands
  { path: "/brands-add-brands", component: AddBrands },
  { path: "/brands-brands-list", component: BrandsList },

  // attributes
  { path: "/attributes-add-attributes", component: AddAttributes },
  { path: "/attributes-attribbutes-list", component: AttributesList },

  // colors
  { path: "/colors-add-color", component: AddColors },
  { path: "/colors-colors-list", component: ColorsList },

  // sizes
  { path: "/sizes-add-sizes", component: AddSizes },
  { path: "/sizes-sizes-list", component: SizesList },

  // Customers
  { path: "/customers-customers-List", component: CustomersList },

  // Orders
  { path: "/orders-orders-list", component: OrdersList },

  // marketing overview
  { path: "/marketing-marketing-overview", component: MarketingOverview },

  // coupens
  { path: "/coupons-overview", component: Overview },
  { path: "/coupons-add-coupon", component: AddCoupens },
  { path: "/coupons-coupons-list", component: CoupensList },

  // analytics
  { path: "/analytics-coupons", component: Coupens },
  { path: "/analytics-orders", component: Orders },
  { path: "/analytics-overview", component: AnalyticsOverview },
  { path: "/analytics-products", component: Prooducts },
  { path: "/analytics-revenue", component: Revenue },
  { path: "/analytics-settings", component: AnalyticsSettings },
  { path: "/analytics-stock", component: Stocks },
  { path: "/analytics-taxes", component: Taxes },
  { path: "/analytics-variations", component: Variations },

  // comments
  { path: "/comments", component: Comments },

  // media
  { path: "/media-media-list", component: MediaList },

  // reviews
  { path: "/reviews-reviews-list", component: ReviewsList },
